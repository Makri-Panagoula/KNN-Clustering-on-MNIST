...
ARGSL = –d datasets/input.dat –q datasets/query.dat –k 3 -L 5 -ο output_lsh -Ν 1 -R 0
...
ARGSC = –d datasets/input.dat –q datasets/query.dat –k 7 -M 200 -probes 20 -ο output_cube -Ν 1 -R 0
...
ARGS_G = –d datasets/output.dat –q datasets/output_query.dat –k 50 -E 60 -R 20 -N 1 -l 10 -m 1 -o output_graph -id datasets/input.dat –iq datasets/query.dat
